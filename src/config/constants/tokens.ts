...
export const MAVR: { [chainId: number]: Token } = {
  [ChainId.MAINNET]: new Token(
    ChainId.MAINNET,
    '0xee927B622f18C6a0859a78aBa6156a5afea09678',
    18,
    'MAVR',
    'MAVERICK',
  ),
...
const tokens = {
  ...
  mavr:{
    symbol: 'MAVR',
    address: {
      56: '0xee927B622f18C6a0859a78aBa6156a5afea09678', /* 0x504BA9B11c727688cCca62BAE112C2c62085129E */
      97: ''
    },
    decimals: 18,
    projectLink: 'http://mavr.finance/',
  },
  xbpt:{
    symbol: 'xBPT',
    address: {
